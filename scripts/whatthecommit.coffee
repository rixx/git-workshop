...
whatTheCommit = ->
	commit = messages[Math.floor(Math.random()*messages.length)]
	$('h5.whatthecommit').text commit
...
$ ->
	...
	Reveal.addEventListener 'slidechanged', (event) ->
		...
		if $(event.currentSlide).hasClass 'whatthecommit'
			$('h5.whatthecommit').show()
		else
			$('h5.whatthecommit').hide()